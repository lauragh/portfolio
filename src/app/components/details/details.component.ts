...
export class DetailsComponent implements AfterViewInit{
  ...
  private getProjectDetails(): ProjectDetails[] {
    return [
      ...
      },
      {
        ...
        repository: this.translate.game.repository,
      },
      {
        ...
        repository: this.translate.mobbler.repository,
      },
      {
        ...
        repository: this.translate.weather.repository,
      },
      {
        ...
        repository: this.translate.cobli.repository,
        memory: this.translate.cobli.memory,
      }
    ];
  }
  ...
  onClick(event: Event): void {
    ...
    if(
      this.detailsContent?.nativeElement &&
      !this.detailsContent.nativeElement.contains(target) &&
      target.tagName !== 'IMG' &&
